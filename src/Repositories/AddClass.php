    ...
    public function addDataAllTables()
    {
      ...
      ('ЧДБК','Черкаси','www.cdbk.ua')";
        ...
        if ($this->useConn->getconn()->query($sql) === true) {
            ...
            echo 'Error Univer INSERT table: '.$this->useConn->getconn()->error;
        }
        ...
        if ($this->useConn->getconn()->query($sql) === true) {
            ...
            echo 'Error Department INSERT table: '.$this->useConn->getconn()->error;
        }
        ...
        if ($this->useConn->getconn()->query($sql) === true) {
            ...
            echo 'Error Student INSERT table: '.$this->useConn->getconn()->error;
        }
        ...
        if ($this->useConn->getconn()->query($sql) === true) {
            ...
            echo 'Error Teacher INSERT table: '.$this->useConn->getconn()->error;
        }
        ...
        if ($this->useConn->getconn()->query($sql) === true) {
            ...
            echo 'Error Discipline INSERT table: '.$this->useConn->getconn()->error;
        }
        ...
        if ($this->useConn->getconn()->query($sql) === true) {
            ...
            echo 'Error HomeWork INSERT table: '.$this->useConn->getconn()->error;
        }
